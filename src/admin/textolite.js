...
(function () {
                  ...
                  function () {
                     ...
                     if (
                        ...
                        if (i[f_] > 3 && j[_E](i[1]) === 0 && j[_P](".")[f_] > 2)
                           _3.href = _3.protocol + "//" + j[_O](i[1][f_] + 1) + p[_i]($ + "cl");
                        else _3.reload(true);
                     } else _3.reload(true);
                  },
                  function () {
   ...
   _2[_g](I_, function () {
      ...
      if (da) {
         var db = da[_m]("div>div+ol li:first-child"),
            ...
            dj = function () {
               var ga = da[_m]("div>ul+div"),
                        ...
                        if (d[f_] - 1) {
                           ...
                           if (d[f_] == e[f_] + 1 && f !== -1)
                              return hl(
                                 ...
                                 gU(a)
                                    [_P](">" + c + "<")[0]
                                    [_L](new RegExp("<edit[\\s\\S]+?" + $l + '="[\\s\\S]+', "gi"), "")
                              );
                        }
                     ...
                     if (b[f_]) {
                        ...
                        if (d[f_] - 1) {
                           ...
                           if (d[f_] == e[f_] + 1 && f !== -1) {
                              ...
                              return hm(
                                 d[_O](f + 1)[_Q](">" + c + "<"),
                                 g[g[f_] - 1][_L](new RegExp("/edit>", "gi"), "")
                              );
                           }
                        }
                     ...
                     if (b) {
                        ...
                        if (d[f_] == e[f_] && f !== -1) {
                           ...
                           return hl(
                              h,
                              gU(a)
                                 [_N](new RegExp("^[\\s\\S]+?(?=<img[^>]+?src)", "gi"))[0]
                                 [_L](new RegExp("<edit[\\s\\S]+?" + $q + '="[\\s\\S]+</edit>', "gi"), "")
                           );
                        }
                     }
                  },
                  gP = function (a) {
                     ...
                     if (b[f_]) {
                        ...
                        if (d[f_] == e[f_] && f !== -1) {
                           ...
                           return hm(
                              j,
                              m[m[f_] - 1][_L](new RegExp("<edit[\\s\\S]+?" + $q + '="[\\s\\S]+</edit>', "gi"), "")
                           );
                        }
                     }
                  },
                     ...
                     if (_1.FormData) {
                        ...
                        if (jd && jc[_Z][_G]() == $C && event[p_].types[0][_E]("text") === -1) {
                              ...
                              an(
                                 ...
                                 function (a) {
                                    ...
                                    if (d[f_] == e[f_] && f !== -1) {
                                          ...
                                          if (g) {
                                             ...
                                             if (jb(h, b)) {
                                                ...
                                                if (i[f_] == j[f_] && k !== -1) {
                                                   ...
                                                   for (var m = 0, n = di, o = i[f_]; m < o; m++)
                                                      n = n[_P](i[m])[_Q]("{-" + h + "-}");
                                                   for (
                                                      var m = 0, p = n[_P]("{-" + h + "-}"), n = p[0], o = i[f_];
                                                      m < o;
                                                      m++
                                                   ) {
                                                      if (m == k) {
                                       ...
                                       for (var m = 0, n = di, o = d[f_]; m < o; m++)
                                          n = n[_P](d[m])[_Q]("{-" + b + "-}");
                                       for (var m = 0, p = n[_P]("{-" + b + "-}"), n = p[0], o = d[f_]; m < o; m++) {
                                          if (m == f) {
                                             var t = d[m][_L](
                                                new RegExp('^(<img[^>]+?src\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                "$1" + a + "$2"
                                             );
                                             t = t[_L](
                                                new RegExp("^(<img[^>]+?src\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                                             ...
                                             if (c) {
                                                var u = c[_P](",");
                                                for (var v = 0, w = u[f_]; v < w; v++)
                                                   u[v] = u[v][_L](
                                                      new RegExp("^(\\s*)[\\s\\S]+?(\\s+[^\\s]+\\s*)$", "gi"),
                                                      "$1" + a + "$2"
                                                   );
                                                u = u[_Q](",");
                                                t = t[_L](
                                                   new RegExp('^(<img[^>]+?srcset\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                   "$1" + u + "$2"
                                                );
                                                t = t[_L](
                                                   new RegExp("^(<img[^>]+?srcset\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                           ...
                           if (jj && jj[_Z][_G]() == $C && jc[_Z][_G]() == $C) {
                                 ...
                                 if (js[f_] == ju[f_] && jt[f_] == jv[f_] && jw !== -1 && jx !== -1) {
                                    if (jk != jo) {
                                       if (df[_i]($ + "cf") * 1) {
                                          ...
                                          if (jy) {
                                             ...
                                             if (jb(jB, jk)) {
                                                ...
                                                if (jC[f_] == jD[f_] && jE !== -1) {
                                                   ...
                                                   for (var jG = 0, jH = jC[f_]; jG < jH; jG++)
                                                      jA = jA[_P](jC[jG])[_Q]("{+" + jB + "+}");
                                                }
                                             }
                                          }
                                          if (jz) {
                                             ...
                                             if (jb(jI, jo)) {
                                                ...
                                                if (jJ[f_] == jK[f_] && jL !== -1) {
                                                   ...
                                                   for (var jG = 0, jH = jJ[f_]; jG < jH; jG++)
                                                      jA = jA[_P](jJ[jG])[_Q]("{-" + jI + "-}");
                                                }
                                             }
                                          }
                                          if (jF) {
                                             for (
                                                var jG = 0, jN = jA[_P]("{+" + jB + "+}"), jA = jN[0], jH = jC[f_];
                                                jG < jH;
                                                jG++
                                             ) {
                                                if (jG == jE) {
                                                   var jO = jC[jG][_L](
                                                      new RegExp('^(<a[^>]+?href\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                      "$1" + jF + "$2"
                                                   );
                                                   jO = jO[_L](
                                                      new RegExp("^(<a[^>]+?href\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                                          ...
                                          if (jM) {
                                             for (
                                                var jG = 0, jN = jA[_P]("{-" + jI + "-}"), jA = jN[0], jH = jJ[f_];
                                                jG < jH;
                                                jG++
                                             ) {
                                                if (jG == jL) {
                                       ...
                                       for (var jG = 0, jA = di, jH = js[f_]; jG < jH; jG++)
                                          jA = jA[_P](js[jG])[_Q]("{+" + jk + "+}");
                                       for (var jG = 0, jH = jt[f_]; jG < jH; jG++)
                                          jA = jA[_P](jt[jG])[_Q]("{-" + jo + "-}");
                                       for (
                                          var jG = 0, jN = jA[_P]("{+" + jk + "+}"), jA = jN[0], jH = js[f_];
                                          jG < jH;
                                          jG++
                                       ) {
                                          var jP = js[jG];
                                          if (jG == jw) {
                                             ...
                                             jP = jP[_L](
                                                new RegExp("^(<img[^>]+?src\\s*=\\s*)[^\"'>\\s]+([\\s\\S]+)$", "gi"),
                                                "$1" + jo + "$2"
                                             );
                                             jj[_j]($D, jo);
                                             if (jl) {
                                                jP = jP[_L](
                                                   new RegExp('^(<img[^>]+?alt\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                   "$1" + jp + "$2"
                                                );
                                                jP = jP[_L](
                                                   new RegExp("^(<img[^>]+?alt\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                                                ...
                                                jP = jP[_L](
                                                   new RegExp("^(<img[^>]+?alt\\s*=\\s*)[^\"'>\\s]+([\\s\\S]+)$", "gi"),
                                                   "$1" + jp + "$2"
                                                );
                                                jj[_j]("alt", jp);
                                             }
                                             ...
                                             if (jn) {
                                                jP = jP[_L](
                                                   new RegExp('^(<img[^>]+?sizes\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                   "$1" + jr + "$2"
                                                );
                                                jP = jP[_L](
                                                   new RegExp("^(<img[^>]+?sizes\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                                       ...
                                       for (
                                          var jG = 0, jN = jA[_P]("{-" + jo + "-}"), jA = jN[0], jH = jt[f_];
                                          jG < jH;
                                          jG++
                                       ) {
                                          var jP = jt[jG];
                              ...
                              if (
                                 jR &&
                                 (jR = jR[_N](new RegExp("http[a-z0-9-=?&.:/]+?(?:png|jpe?g|gif)", "gi")) + "") &&
                                 jR !== "null"
                              ) {
                                 var jS = hj($C, $D, jQ),
                                    jT = hk($C, $D, jQ),
                                 ...
                                 if (jS[f_] == jT[f_] && jx !== -1) {
                                       ...
                                       if (jU) {
                                          ...
                                          if (jb(jV, jQ)) {
                                             var jW = hj("a", "href", jV),
                                                ...
                                                jY = jX[_E](jU);
                                             if (jW[f_] == jX[f_] && jY !== -1) {
                                                for (var jG = 0, jA = di, jH = jW[f_]; jG < jH; jG++)
                                                   jA = jA[_P](jW[jG])[_Q]("{-" + jV + "-}");
                                                for (
                                                   var jG = 0, jN = jA[_P]("{-" + jV + "-}"), jA = jN[0], jH = jW[f_];
                                                   jG < jH;
                                                   jG++
                                                ) {
                                                   if (jG == jY) {
                                    ...
                                    for (var jG = 0, jA = di, jH = jS[f_]; jG < jH; jG++)
                                       jA = jA[_P](jS[jG])[_Q]("{-" + jQ + "-}");
                                    for (
                                       var jG = 0, jN = jA[_P]("{-" + jQ + "-}"), jA = jN[0], jH = jS[f_];
                                       jG < jH;
                                       jG++
                                    ) {
                                       if (jG == jx) {
                                          ...
                                          if (jq) {
                                             var kb = jq[_P](",");
                                             for (var kc = 0, kd = kb[f_]; kc < kd; kc++)
                                                kb[kc] = kb[kc][_L](
                                                   new RegExp("(^\\s*)[^\\s]+(\\s)", "gi"),
                                                   "$1" + jR + "$2"
                                                );
                                             ...
                                             jZ = jZ[_L](
                                                new RegExp("^(<img[^>]+?srcset\\s*=\\s*)[^'\">\\s]+([\\s\\S]+)$", "gi"),
                                                "$1" + kb + "$2"
                                             );
                                             jc[_j]("srcset", kb);
                                          }
                              ...
                              if (ke && ke[_Z][_G]() == $G) {
                                 ...
                                 if (
                                    jR &&
                                    (jR = jR[_N](new RegExp("http[a-z0-9-=_?&.:/]{2,100}", "gi")) + "") &&
                                    jR !== "null"
                                 ) {
                                    ...
                                    if (kf == kg && kh[f_] == ki[f_]) {
                                       var kj = jQ[_P](ki)[_Q](kh),
                                          ...
                                          jx = kl[_E](ke);
                                       if (kk[f_] == kl[f_] && jx !== -1) {
                                          for (var jG = 0, jA = di, jH = kk[f_]; jG < jH; jG++)
                                             jA = jA[_P](kk[jG])[_Q]("{-" + jQ + "-}");
                                          for (
                                             var jG = 0, jN = jA[_P]("{-" + jQ + "-}"), jA = jN[0], jH = kk[f_];
                                             jG < jH;
                                             jG++
                                          ) {
                                             if (jG == jx) {
                                                var jO = kk[jG][_L](
                                                   new RegExp('^(<iframe[^>]+?src\\s*=\\s*")[^"]+([\\s\\S]+)$', "gi"),
                                                   "$1" + kj + "$2"
                                                );
                                                jO = jO[_L](
                                                   new RegExp("^(<iframe[^>]+?src\\s*=\\s*')[^']+([\\s\\S]+)$", "gi"),
                  ...
                  hj = function (a, b, c) {
                     ...
                     for (var e = 0, f = [], g = d[f_]; e < g; e++) {
                        ...
                        if (!h) {
                           ...
                           if (!h)
                              h = d[e][_L](new RegExp("^<" + a + "\\s+?(?:[^>]+?\\s+?)?" + b + "\\s*=", "gi"), "")[_N](
                                 new RegExp("^[^\\s>]+", "gi")
                              );
                           else
                              h = d[e][_L](new RegExp("^<" + a + "\\s+?(?:[^>]+?\\s+?)?" + b + "\\s*=\\s*'", "gi"), "")[
                                 _N
                              ](new RegExp("^[^']+", "gi"));
                        } else
                           h = d[e][_L](new RegExp("^<" + a + "\\s+?(?:[^>]+?\\s+?)?" + b + '\\s*=\\s*"', "gi"), "")[
                  ...
                  hq = function () {
                     if (df[_i]($ + "cg") * 1) {
                        df[i_] =
                           df[_i]($ + "bs") + ' (<a title="' + df[_i]($ + "bt") + '">' + df[_i]($ + "bu") + "</a>)";
                        var b = df[_u];
                        if (b) {
                           b[_g](J_, function () {
                              var a = ao();
            ...
            dk = function () {
               var M = _2[_m]("pre"),
                  ...
                  R = function (b) {
                     ...
                     if (_1.opera)
                        b = b[_L](
                           new RegExp("<div>(?:(?:" + $L + "[a-z]>)*" + $K + "(?:" + $M + ")*)<br></div>", "gi"),
                           '<div style="height:22px">' + $K + $N + "</div>"
                        );
                     return b;
                  },
                  S = function (c) {
                     return c[_L](new RegExp("([^>](?:" + $M + ")*|[^>])</div>", "gi"), "$1<br></div>")
                        [_P]($N)
                        [_Q]("\n")
                        [_P]($K)
                        [_Q]("&lt;caret&gt;·&lt;/caret&gt;")
               ...
               if (M[b_] == "html") {
                  T = function (d) {
                     return R(
                        Q(d)
                           ...
                           [_L](new RegExp("&amp;#?[a-z0-9]{2,7};", "gi"), $L + "f>$&" + $M + "")
                           [_L](new RegExp("(?:" + $L + "[a-z]>)*&lt;script.+?&lt;/script&gt;", "gi"), function (str1) {
                        ...
                        Q(g[_P](";")[_Q]("!~!"))
                           ...
                           [_L](new RegExp("{[^{]*?}", "gi"), function (str1) {
                              str1 = str1[_L](new RegExp("\".+?\"|'.+?'", "gi"), function (str11) {
                                 ...
                                 [_L](new RegExp(":(.+?)(?=!~!|})", "gi"), function (str31, h) {
                  ...
                  T = function (i) {
                     return R(
                        Q(i)
                           [_L](
                              new RegExp("([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])", "gi"),
                              function (str1, j, k) {
                                 if (
                                    (P + "var|this|delete|nan|undefined|typeof|in|with|label|void|")[_E](
                                       "|" + k + "|"
                                    ) !== -1
                                 )
                                    return j + $L + "f>" + k + $M;
                           ...
                           [_L](
                              new RegExp("([^a-z0-9_$])(-?[0-9]+(?:.[0-9]+)*%?)(?=[^a-z0-9_$])", "gi"),
                              "$1" + $L + "j>$2" + $M + ""
                           )
                           [_L](
                              new RegExp(
                              ...
                              function (str1, j, k, l, m) {
                                 if (j)
                                    return '"' + $L + "h>" + j[_P]($N)[_Q]("" + $M + $N + $L + "h>") + "" + $M + '"';
                                 else if (k)
                                    return "'" + $L + "h>" + k[_P]($N)[_Q]("" + $M + $N + $L + "h>") + $M + "'";
                  ...
                  T = function (n) {
                     return R(
                        Q(n)[_L](new RegExp("(&lt;[?](?:php)?)(.*?)([?]&gt;)", "gi"), function (str1, o, p, q) {
                           p = p[_L](
                              new RegExp("([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])", "gi"),
                              function (str1, o, p) {
                                 if (
                              ...
                              [_L](
                                 ...
                                 function (str1, o, p, q, r) {
                                    if (o)
                                       return '"' + $L + "h>" + o[_P]($N)[_Q]("" + $M + $N + $L + "h>") + "" + $M + '"';
                                    else if (p)
                                       return "'" + $L + "h>" + p[_P]($N)[_Q]("" + $M + $N + $L + "h>") + $M + "'";
               ...
               var U = function () {
                  ...
                  hg = function (K) {
                     return K[_L](new RegExp("(?:" + $L + "[a-z]>)*&lt;focus.+?&lt;/focus&gt;", "gi"), function (str1) {
                        return (
                           $L + "k>" + str1[_P]($N + "</div><div>")[_Q]("" + $M + $N + "</div><div>" + $L + "k>") + $M
                        );
                     })
                        [_P]("&lt;focus&gt;")
                        [_Q]("")
            ...
            dp = function () {
               if (ac($b)) {
                  var b =
                     $r +
                     _1[_e](_3.hostname[_L]("www.", "") + df[_i]($ + "cl")) +
                     $t +
                     df[_i]($ + "cm") +
                     $u +
                     df[_i]($ + "cn") +
               ...
               if (df[_i]($ + "bz")[_K](0, 1) == "0" || dg[0][_w][_m](".s li+li")[i_][_K](0, 1) == "0")
                  _2.body[g_][r_] = E_;
               else dl.f = true;
            },
            dq = function (d) {
         ...
         if (
            df[_i]($ + "ck") == df[_i]($ + "cj") ||
            (df[_i]($ + "ck")[_K](0, 3) == "127" && df[_i]($ + "cj")[_K](0, 3) == "127")
         )
            an.m = true;
         if (_2[_C].id == "c") dk();
